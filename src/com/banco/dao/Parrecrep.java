...
/**
 * The persistent class for the parrecrep database table.
 * 
 */
@Entity
@Table(name="parrecrep")
@NamedQuery(name="Parrecrep.findAll", query="SELECT p FROM Parrecrep p")
public class Parrecrep implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="PARRECREP_COD_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="PARRECREP_COD_GENERATOR")
