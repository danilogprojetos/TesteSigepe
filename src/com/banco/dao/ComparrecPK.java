...
/**
 * The primary key class for the comparrec database table.
 * 
 */
@Embeddable
public class ComparrecPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ComparrecPK)) {
			return false;
		}
		ComparrecPK castOther = (ComparrecPK)other;
		return 
